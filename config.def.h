...
static const double accel_speed = -0.95;
...
static const char *powermenu[] = { "rofi", "-show", "p", "-modi", "p:rofi-power-menu --choices=lockscreen/shutdown/reboot --confirm=''", NULL};
static const char *clipboard[] = { "clipcat-menu", NULL};
static const char *firefox[] = { "firefox", NULL };
static const char *firefoxhidden[] = { "firefox", "--private-window", NULL };
...
static const Key keys[] = {
	...
	{ MODKEY,                    XKB_KEY_Escape,           spawn,            {.v = powermenu } },
	{ MODKEY,                    XKB_KEY_b,           spawn,            {.v = firefox} },
	{ MODKEY|WLR_MODIFIER_SHIFT, XKB_KEY_b,           spawn,            {.v = firefoxhidden} },
